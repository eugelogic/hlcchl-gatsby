...
const HomepageContent = () => (
  <div className="homepage-content">
    ...
    <p>In view of the outbreak of <strong>Coronavirus (COVID-19)</strong>, <br />the Monday and Friday lunch clubs are closing with immediate effect. <br />The film club is also closing with immediate effect and therefore <br />the film programmed to be shown on the 20th of March is cancelled.</p>
